...
import {IRenderer, RendererType, SvgRenderer, ThreeRenderer} from './renderer';
...
export class Chart implements IChart {
  ...
  resize(dim: Dimension) {
    this.coordinator.setDomContainerDimension(dim);
    this.renderer.onResize(dim);
  ...
  private redraw() {
    // console.log('redraw happened', new Error().stack);
    this.seriesLineView.internalOnlyRedraw();
    this.renderer.flush();
